...
namespace UIWidgetsSamples
{
	...
	public class TestScene2 : MonoBehaviour
	{
		...
		public void SetTableDefaultItem()
		{
			...
			var layout = SteamSpyView.Container.GetComponent<EasyLayout.EasyLayout>();
			layout.ChildrenWidth = EasyLayout.ChildrenSize.DoNothing;
		...
		public void SetTileDefaultItem1()
		{
			...
			var layout = SteamSpyView.Container.GetComponent<EasyLayout.EasyLayout>();
			layout.ChildrenWidth = EasyLayout.ChildrenSize.SetPreferred;
