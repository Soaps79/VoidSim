...
namespace UIWidgetsSamples.Shops
{
	...
	public class TraderListView : ListViewCustom<TraderListViewComponent,JRPGOrderLine>
	{
		...
		static protected int ItemNameComparer(JRPGOrderLine x, JRPGOrderLine y)
		{
		...
		/// <param name="y">Second JRPGOrderLine.</param>
		/// <returns>A 32-bit signed integer that indicates whether X precedes, follows, or appears in the same position in the sort order as the Y parameter.</returns>
		static protected int ItemAvailableComparer(JRPGOrderLine x, JRPGOrderLine y)
		{
		...
		/// <param name="y">Second JRPGOrderLine.</param>
		/// <returns>A 32-bit signed integer that indicates whether X precedes, follows, or appears in the same position in the sort order as the Y parameter.</returns>
		static protected int PriceComparer(JRPGOrderLine x, JRPGOrderLine y)
		{
		...
		/// <param name="y">Second JRPGOrderLine.</param>
		/// <returns>A 32-bit signed integer that indicates whether X precedes, follows, or appears in the same position in the sort order as the Y parameter.</returns>
		static protected int CountComparer(JRPGOrderLine x, JRPGOrderLine y)
		{
