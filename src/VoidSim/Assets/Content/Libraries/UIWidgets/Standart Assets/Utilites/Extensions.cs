...
namespace UIWidgets
{
	...
	public static class Extensions
	{
		...
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		static public List<TreeNode<T>> GetAllSubNodes<T>(this ObservableList<TreeNode<T>> nodes)
		{
		...
		/// <typeparam name="T">The 1st type parameter.</typeparam>
		static public void GetSubNodes<T>(ObservableList<TreeNode<T>> nodes, List<TreeNode<T>> subnodes)
		{
			if (nodes==null)
			{
				return ;
